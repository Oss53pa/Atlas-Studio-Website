  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-7">
        <div>
          <h1 className="text-neutral-text text-2xl font-bold mb-1">Templates Email</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        {templates.map((tpl) => (
          <div
            key={tpl.id}
            className="bg-white border border-warm-border rounded-xl p-5 flex flex-col hover:border-gold/40 transition-colors"
          >
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-neutral-text font-semibold text-[15px] leading-tight">{tpl.name}</h3>
            ...
            <p className="text-neutral-muted text-[13px] leading-relaxed mb-4 flex-1">
              {tpl.description}
            </p>

            <div className="mb-4">
              <div className="flex items-center gap-1.5 mb-2">
                <Code size={12} className="text-neutral-muted" />
                <span className="text-[11px] font-semibold text-neutral-muted uppercase tracking-wide">Variables</span>
              </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 border border-warm-border rounded-lg bg-white text-neutral-body text-[13px] font-medium hover:border-gold/40 hover:text-gold transition-colors"
            >
              <Eye size={14} />
              Aper&ccedil;u
            </button>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-warm-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-neutral-text font-semibold text-[15px]">{previewTpl.name}</h2>
                  <p className="text-neutral-muted text-[12px] flex items-center gap-1">
                    <Send size={10} />
                    <span className="font-mono">{previewTpl.sender}</span>
                    &middot; Sujet : <span className="font-medium text-neutral-body">{preview.subject}</span>
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-medium border border-warm-border text-neutral-muted hover:border-gold/40 hover:text-gold transition-colors"
                >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg flex items-center justify-center text-neutral-muted hover:bg-neutral-100 hover:text-neutral-text transition-colors"
                >
                  <X size={18} />
                </button>
              </div>
            ...
            {/* Variables bar */}
            <div className="px-6 py-3 bg-neutral-50 border-b border-warm-border overflow-x-auto">
              <div className="flex items-center gap-2 flex-wrap text-[12px]">
                <span className="text-[11px] font-semibold text-neutral-muted uppercase tracking-wide mr-1">Test :</span>
                {previewTpl.variables.map((v) => (
                  <span key={v.name} className="inline-flex items-center mr-2 whitespace-nowrap">
                    <span className="font-mono text-gold/80">{v.name}</span>
