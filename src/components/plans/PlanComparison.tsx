        ...
        {plans.slice(0, 3).map((plan) => {
          ...
          return (
            <div key={plan.id} style={{
              background: "#FFFFFF", border: isCurrent ? "2px solid var(--c-accent)" : "1px solid #E8E8E0",
              borderRadius: 12, padding: 24, display: "flex", flexDirection: "column", position: "relative",
            }}>
              {isCurrent && <span style={badge("var(--c-accent)")}>Plan actuel</span>}
              ...
              <div style={{ marginTop: "auto", paddingTop: 16 }}>
                <button onClick={() => onSelectPlan(plan.id)} disabled={isCurrent} style={{
                  ...
                  cursor: isCurrent ? "default" : "pointer", background: isCurrent ? "#E8E8E0" : "var(--c-accent)",
