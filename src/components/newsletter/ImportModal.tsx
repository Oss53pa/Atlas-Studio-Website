    ...
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-p-surface border border-p-border rounded-2xl w-full max-w-lg p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onClose} className="p-1 rounded hover:bg-p-surface-alt text-[#888]"><X size={18} /></button>
        </div>
        ...
        {result ? (
          ...
          <>
            ...
            {preview.length > 0 && (
              <div className="overflow-x-auto mb-4 bg-p-bg rounded-lg p-3">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div>
                ...
                <select value={mapping.email} onChange={e => setMapping({ ...mapping, email: e.target.value })}
                  className="w-full px-2 py-1.5 bg-p-surface-alt rounded text-xs text-[#F5F5F5] outline-none">
