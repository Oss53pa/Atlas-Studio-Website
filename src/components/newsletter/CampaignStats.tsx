  ...
  return (
    <div className="p-6 overflow-auto">
      <div className="flex items-center gap-3 mb-6">
        <button onClick={onBack} className="p-2 rounded-lg hover:bg-p-surface-alt text-[#888] hover:text-[#F5F5F5]"><ArrowLeft size={18} /></button>
        <div>
      ...
      {campaign.ab_test_enabled && (
        <div className="mt-6 bg-p-surface border border-p-border rounded-xl p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-lg bg-p-surface-alt/30">
