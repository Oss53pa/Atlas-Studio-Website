  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button onClick={() => setShowImport(true)} className="flex items-center gap-1.5 px-3 py-2 border border-p-border text-[#F5F5F5] rounded-lg text-sm hover:bg-p-surface-alt"><Upload size={14} />Importer CSV</button>
        <button onClick={handleExport} className="flex items-center gap-1.5 px-3 py-2 border border-p-border text-[#F5F5F5] rounded-lg text-sm hover:bg-p-surface-alt"><Download size={14} />Exporter</button>
      </div>
      ...
      {showAdd && (
        <div className="mb-4 p-4 bg-p-surface border border-p-accent/30 rounded-xl flex items-end gap-3">
          <div className="flex-1">
            ...
            <input value={newEmail} onChange={e => setNewEmail(e.target.value)} placeholder="email@example.com" className="w-full px-3 py-1.5 bg-p-surface-alt rounded text-sm text-[#F5F5F5] outline-none" />
          </div>
          <div className="flex-1">
            <label className="text-[11px] text-[#888] mb-1 block">Nom (optionnel)</label>
            <input value={newName} onChange={e => setNewName(e.target.value)} placeholder="Nom complet" className="w-full px-3 py-1.5 bg-p-surface-alt rounded text-sm text-[#F5F5F5] outline-none" />
          </div>
