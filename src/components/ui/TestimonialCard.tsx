...
export function TestimonialCard({ name, role, company, text, avatar }: TestimonialCardProps) {
  return (
    <div className="relative bg-gradient-to-br from-white to-warm-bg border border-warm-border border-l-4 border-l-gold rounded-2xl p-7 card-hover overflow-hidden">
      <div className="absolute top-4 right-5 text-gold/10 text-7xl font-logo leading-none pointer-events-none select-none">
        "
      </div>
