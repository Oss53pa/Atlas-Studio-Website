    ...
    <div className="min-h-screen bg-onyx">
      ...
      <section className="relative pt-28 pb-12 md:pt-36 md:pb-16 px-5 md:px-10 lg:px-16 border-b border-white/[0.06] overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <h1 className="font-display font-medium tracking-[-0.035em] leading-[0.98] text-[22px] md:text-[28px] text-neutral-light max-w-4xl mb-8">
            Le journal{" "}
      ...
      <section className="relative bg-ink-100 border-t border-white/[0.06] py-24 md:py-32 px-5 md:px-10 lg:px-16 overflow-hidden">
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <h2 className="font-display font-medium tracking-[-0.03em] leading-[0.98] text-[18px] md:text-[24px] text-neutral-light max-w-3xl mb-10">
