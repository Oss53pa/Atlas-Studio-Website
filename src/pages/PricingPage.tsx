              ...
              <article className="relative border-t border-white/[0.06] pt-8 h-full flex flex-col">
                ...
                <div className="mt-auto border-t border-white/[0.06] pt-5">
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-gradient-gold font-mono text-[24px] md:text-[28px] font-semibold tracking-tight tabular-nums">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-12 items-baseline">
        <div className="lg:col-span-7">
          ...
          <Link to={`/applications/${app.id}`} className="block group">
            <h3 className="font-display font-medium tracking-[-0.025em] leading-[1.04] text-[14px] md:text-[16px] lg:text-[26px] text-neutral-light group-hover:opacity-80 transition-opacity">
              {app.name}
            </h3>
          </Link>
    ...
    <div className="min-h-screen bg-onyx">
      ...
      <section className="relative pt-28 pb-12 md:pt-36 md:pb-20 px-5 md:px-10 lg:px-16 border-b border-white/[0.06] overflow-hidden">
        ...
        <div className="relative max-w-[1280px] mx-auto">
          ...
          <h1 className="font-display font-medium tracking-[-0.035em] leading-[0.98] text-[22px] sm:text-[15px] md:text-[17px] lg:text-[38px] text-neutral-light mb-8 max-w-5xl">
