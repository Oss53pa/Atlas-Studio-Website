  ...
  return (
    <div className="min-h-screen bg-onyx flex flex-col px-5 md:px-10 lg:px-16 pt-28 md:pt-36 pb-16 relative overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto w-full flex-1 flex flex-col justify-center">
        ...
        {/* 404 monumental */}
        <div className="font-display font-medium tracking-[-0.04em] leading-[0.85] text-[56px] sm:text-[80px] md:text-[104px] lg:text-[128px] text-[#A9B57E]/85 mb-10 tabular-nums">
          404
        </div>

        <h1 className="font-display font-medium tracking-[-0.025em] leading-[1.04] text-[14px] md:text-[16px] lg:text-[26px] text-neutral-light max-w-3xl mb-6">
